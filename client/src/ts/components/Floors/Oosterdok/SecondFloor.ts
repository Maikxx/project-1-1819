        ...
        return M.create('g', { 'data-name': 'Books' }, [
            M.create('g', { 'data-name': 'other' }, [
                M.create('rect', {
                    ...
                    width: '13.81',
                    height: '93.43',
                    'event:click': () => router.navigate(`${baseForwardUrl}/facet=language(ara)&facet=type(book)`),
                ...
                M.create('rect', {
                    ...
                    width: '13.81',
                    height: '93.43',
                    'event:click': () => router.navigate(`${baseForwardUrl}/facet=language(rus)&facet=type(book)`),
                ...
                M.create('rect', {
                    ...
                    width: '13.81',
                    height: '93.43',
                    'event:click': () => router.navigate(`${baseForwardUrl}/facet=language(fri)&facet=type(book)`),
                ...
                M.create('rect', {
                    ...
                    width: '13.81',
                    height: '93.43',
                    'event:click': () => router.navigate(`${baseForwardUrl}/facet=language(nor)&facet=type(book)`),
                ...
                M.create('rect', {
                    ...
                    width: '13.81',
                    height: '68.96',
                    'event:click': () => router.navigate(`${baseForwardUrl}/facet=language(jpn)&facet=type(book)`),
                ...
                M.create('rect', {
                    ...
                    width: '13.81',
                    height: '68.96',
                    'event:click': () => router.navigate(`${baseForwardUrl}/facet=language(cat)&facet=type(book)`),
                ...
                M.create('rect', {
                    ...
                    width: '13.81',
                    height: '93.43',
                    'event:click': () => router.navigate(`${baseForwardUrl}/facet=language(cze)&facet=type(book)`),
                ...
                M.create('rect', {
                    ...
                    width: '13.81',
                    height: '93.43',
                    'event:click': () => router.navigate(`${baseForwardUrl}/facet=language(pap)&facet=type(book)`),
                ...
                M.create('rect', {
                    ...
                    width: '13.81',
                    height: '93.43',
                    'event:click': () => router.navigate(`${baseForwardUrl}/facet=language(ice)&facet=type(book)`),
                ...
                M.create('rect', {
                    ...
                    width: '13.81',
                    height: '93.43',
                    'event:click': () => router.navigate(`${baseForwardUrl}/facet=language(kor)&facet=type(book)`),
                ...
                M.create('rect', {
                    ...
                    width: '13.81',
                    height: '93.43',
                    'event:click': () => router.navigate(`${baseForwardUrl}/facet=language(tha)&facet=type(book)`),
            ...
            M.create('g', {
                'data-name': 'dutch',
                className: 'ClickableShape',
                'event:click': () => router.navigate(`${baseForwardUrl}/facet=language(dut)&facet=type(book)`),
            }, [
                M.create('rect', {
                    x: '402.94',
                    y: '392.94',
