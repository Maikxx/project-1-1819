                                ...
                                M.create('g', {
                                    'data-name': 'Books' }, [
                                        M.create('g', {
                                            'data-name': 'other' }, [
                                                M.create('rect', {
                                                    ...
                                                    width: '13.81',
                                                    height: '93.43',
                                                    'event:click': () => router.navigate(`${baseForwardUrl}/language=ara&facet=type(book)`),
                                                    'event:mouseover': this.showTooltip('Arabische boeken'),
                                                    'event:mouseout': () => this.hideTooltip(),
                                                ...
                                                M.create('rect', {
                                                    ...
                                                    width: '13.81',
                                                    height: '93.43',
                                                    'event:click': () => router.navigate(`${baseForwardUrl}/language=rus&facet=type(book)`),
                                                    'event:mouseover': this.showTooltip('Russische boeken'),
                                                    'event:mouseout': () => this.hideTooltip(),
                                                    className: 'ClickableShape',
                                                }),
                                                M.create('rect', {
                                                    ...
                                                    width: '13.81',
                                                    height: '93.43',
                                                    'event:click': () => router.navigate(`${baseForwardUrl}/language=fri&facet=type(book)`),
                                                    'event:mouseover': this.showTooltip('Friese boeken'),
                                                    'event:mouseout': () => this.hideTooltip(),
                                                    className: 'ClickableShape',
                                                }),
                                                M.create('rect', {
                                                    ...
                                                    width: '13.81',
                                                    height: '93.43',
                                                    'event:click': () => router.navigate(`${baseForwardUrl}/language=nor&facet=type(book)`),
                                                    'event:mouseover': this.showTooltip('Noorse boeken'),
                                                    'event:mouseout': () => this.hideTooltip(),
                                                    className: 'ClickableShape',
                                                }),
                                                M.create('rect', {
                                                    ...
                                                    width: '13.81',
                                                    height: '68.96',
                                                    'event:click': () => router.navigate(`${baseForwardUrl}/language=jpn&facet=type(book)`),
                                                    'event:mouseover': this.showTooltip('Japanse boeken'),
                                                    'event:mouseout': () => this.hideTooltip(),
                                                    className: 'ClickableShape',
                                                }),
                                                M.create('rect', {
                                                    ...
                                                    width: '13.81',
                                                    height: '68.96',
                                                    'event:click': () => router.navigate(`${baseForwardUrl}/language=cat&facet=type(book)`),
                                                    'event:mouseover': this.showTooltip('Catalaanse boeken'),
                                                    'event:mouseout': () => this.hideTooltip(),
                                                    className: 'ClickableShape',
                                                }),
                                                M.create('rect', {
                                                    ...
                                                    width: '13.81',
                                                    height: '93.43',
                                                    'event:click': () => router.navigate(`${baseForwardUrl}/language=cze&facet=type(book)`),
                                                    'event:mouseover': this.showTooltip('Tsjechische boeken'),
                                                    'event:mouseout': () => this.hideTooltip(),
                                                    className: 'ClickableShape',
                                                }),
                                                M.create('rect', {
                                                    ...
                                                    width: '13.81',
                                                    height: '93.43',
                                                    'event:click': () => router.navigate(`${baseForwardUrl}/language=pap&facet=type(book)`),
                                                    'event:mouseover': this.showTooltip('Papiamentse boeken'),
                                                    'event:mouseout': () => this.hideTooltip(),
                                                    className: 'ClickableShape',
                                                }),
                                                M.create('rect', {
                                                    ...
                                                    width: '13.81',
                                                    height: '93.43',
                                                    'event:click': () => router.navigate(`${baseForwardUrl}/language=ice&facet=type(book)`),
                                                    'event:mouseover': this.showTooltip('IJslandse boeken'),
                                                    'event:mouseout': () => this.hideTooltip(),
                                                    className: 'ClickableShape',
                                                }),
                                                M.create('rect', {
                                                    ...
                                                    width: '13.81',
                                                    height: '93.43',
                                                    'event:click': () => router.navigate(`${baseForwardUrl}/language=kor&facet=type(book)`),
                                                    'event:mouseover': this.showTooltip('Koreaanse boeken'),
                                                    'event:mouseout': () => this.hideTooltip(),
                                                    className: 'ClickableShape',
                                                }),
                                                M.create('rect', {
                                                    ...
                                                    width: '13.81',
                                                    height: '93.43',
                                                    'event:click': () => router.navigate(`${baseForwardUrl}/language=tha&facet=type(book)`),
                                                    'event:mouseover': this.showTooltip('Thaise boeken'),
                                                    'event:mouseout': () => this.hideTooltip(),
                                                    className: 'ClickableShape',
                                                }),
                                            ]),
                                        M.create('g', {
                                            'data-name': 'dutch',
                                            className: 'ClickableShape',
                                            'event:click': () => router.navigate(`${baseForwardUrl}/language=dut&facet=type(book)`),
                                        }, [
                                            M.create('rect', {
                                                x: '402.94',
                                                y: '392.94',
                                        ...
                                        M.create('g', {
                                            'data-name': 'Elevator', fill: '#ababab' }, [
                                                M.create('path', {
                                                ...
                                                M.create('path', {
                                                    d: 'M1066.86,710.9H1062a1.3,1.3,0,1,0,0,2.6h4.86a1.3,1.3,0,1,0,0-2.6Z',
                                                }),
                                                M.create('path', {
                                                    d: 'm1084.1 712.2a1.3 1.3 0 1 1 -1.3 -1.3 1.3 1.3 0 0 1 1.3 1.3z',
                                                }),
                                                M.create('path', {
                                                ...
                                                M.create('path', {
                                                    d: 'M1066.86,775.66H1062a1.3,1.3,0,1,0,0,2.6h4.86a1.3,1.3,0,1,0,0-2.6Z',
                                                }),
                                                M.create('path', {
                                                    d: 'm1084.1 777a1.3 1.3 0 1 1 -1.3 -1.3 1.3 1.3 0 0 1 1.3 1.3z',
                                                }),
                                                M.create('path', {
                                                ...
                                                M.create('path', {
                                                    d: 'm424.06 1026.8h-4.86a1.3 1.3 0 0 0 0 2.6h4.86a1.3 1.3 0 1 0 0 -2.6z',
                                                }),
                                                M.create('path', {
                                                    d: 'm441.3 1028.1a1.3 1.3 0 1 1 -1.3 -1.3 1.3 1.3 0 0 1 1.3 1.3z',
                                                }),
                                                M.create('path', {
                                                ...
                                                M.create('path', {
                                                    d: 'm363.6 1026.8h-4.86a1.3 1.3 0 0 0 0 2.6h4.86a1.3 1.3 0 1 0 0 -2.6z',
                                                }),
                                                M.create('path', {
                                                    d: 'm380.85 1028.1a1.3 1.3 0 1 1 -1.3 -1.3 1.3 1.3 0 0 1 1.3 1.3z',
                                                }),
                                            ]),
                                        M.create('path', {
                                        ...
                                        M.create('text', {
                                            ...
                                            'font-family': 'ArialMT, Arial', 'font-size': '24px',
                                        },
