...
export const ALLOWED_TAGS_PER_ATTRIBUTE = [
    ...
    { attr: 'height', tags: [ 'canvas', 'embed', 'iframe', 'img', 'input', 'object', 'video', 'rect' ] },
    { attr: 'hidden', tags: '*' },
    ...
    { attr: 'title', tags: '*' },
    { attr: 'transform', tags: [ 'svg', 'g', 'text', 'path', 'polygon', 'rect' ] },
    { attr: 'translate', tags: '*' },
    ...
    { attr: 'width', tags: [ 'canvas', 'embed', 'iframe', 'img', 'input', 'object', 'video', 'rect' ] },
